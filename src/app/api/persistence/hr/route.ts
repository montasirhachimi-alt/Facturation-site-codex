...
const resources = new Set<HrPersistenceResource>(["department", "position", "employee", "contract", "leaveType", "leaveRequest", "leaveBalance", "absence", "attendanceRecord", "documentType", "documentTemplate", "employeeDocument"]);
