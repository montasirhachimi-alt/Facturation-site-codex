...
export function ProductRanking() {
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-soft dark:border-white/10 dark:bg-white/5">
      <div className="mb-4">
      ...
      <div className="space-y-3">
        {productsRanking.map((product, index) => (
          <div key={product.name} className="flex items-center gap-3 rounded-lg border border-slate-100 p-3 dark:border-white/10">
