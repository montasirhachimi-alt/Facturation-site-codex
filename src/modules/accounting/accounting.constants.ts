import type { AccountingPeriodStatus, AccountingWorkspaceId } from "./accounting.types";
...
export const ACCOUNTING_PERIOD_STATUSES = Object.freeze(["open", "closed"] as readonly AccountingPeriodStatus[]);
