...
export const crmRoutes = Object.freeze([
  ...
  defineRoute("crm.contacts", `${CRM_MODULE_ROUTE}/contacts`, "crm.contact.read", "CRM contacts workspace route."),
  defineRoute("crm.contact.details", `${CRM_MODULE_ROUTE}/contacts/[contactId]`, "crm.contact.read", "CRM contact details workspace route."),
  defineRoute("crm.activities", `${CRM_MODULE_ROUTE}/activities`, "crm.activity.read", "CRM activities workspace route."),
  defineRoute("crm.meetings", `${CRM_MODULE_ROUTE}/meetings`, "crm.meeting.read", "CRM meetings workspace route."),
  defineRoute("crm.tasks", `${CRM_MODULE_ROUTE}/tasks`, "crm.task.read", "CRM tasks workspace route."),
  defineRoute("crm.opportunities", `${CRM_MODULE_ROUTE}/opportunities`, "crm.opportunity.read", "CRM sales pipeline workspace route."),
  defineRoute("crm.notes", `${CRM_MODULE_ROUTE}/notes`, "crm.note.read", "CRM notes workspace route.")
