...
function PipelineHero({ filteredCount, stats }: { filteredCount: number; stats: ReturnType<typeof buildStats> }) {
  return (
    <section className="overflow-hidden rounded-[1.5rem] border border-slate-200 bg-hicotech-navy text-white shadow-[0_20px_58px_rgba(10,30,63,0.22)] dark:border-hicotech-dark-border dark:bg-hicotech-dark-card dark:shadow-none">
...
function PipelineHeroStat({ helper, label, value }: { helper: string; label: string; value: string }) {
  return (
    <article className="rounded-xl border border-white/10 bg-white/10 p-3.5 shadow-md shadow-black/10">
